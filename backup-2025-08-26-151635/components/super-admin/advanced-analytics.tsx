...
export default function AdvancedAnalytics() {
  ...
  useEffect(() => {
    // Données d'export d'exemple
    const mockExportHistory: ExportOption[] = [
      {
        id: '1',
        ...
        downloadUrl: '/exports/analytics-complete.pdf',
        fileSize: '12.3 MB'
      },
      {
        id: '2',
        ...
        downloadUrl: '/exports/sales-report.xlsx',
        fileSize: '5.7 MB'
      },
      {
        id: '3',
        type: 'Analytics utilisateurs',
        format: 'CSV',
        status: 'processing',
    ...
    // Rapports configurés d'exemple
    const mockReports: ReportConfig[] = [
      {
        id: '1',
        name: 'Rapport Hebdomadaire Ventes',
        description: 'Rapport automatique des performances de ventes',
        type: 'sales',
        period: '7d',
        format: 'pdf',
        sections: ['overview', 'sales', 'performance'],
        schedule: {
          enabled: true,
          frequency: 'weekly',
          time: '09:00',
          recipients: ['admin@exemple.com', 'manager@exemple.com']
        },
        isActive: true
      },
      {
        id: '2',
        name: 'Analytics Mensuel Complet',
        description: 'Analyse complète mensuelle de toutes les métriques',
        type: 'complete',
        period: '30d',
        format: 'pdf',
        sections: ['overview', 'sales', 'users', 'products', 'performance'],
        schedule: {
          enabled: false,
          frequency: 'monthly',
          time: '08:00',
          recipients: ['ceo@exemple.com']
        },
        isActive: false
      }
    ]
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      const newExport: ExportOption = {
        id: Date.now().toString(),
        type: exportConfig.type === 'all' ? 'Données complètes' : 
              exportConfig.type === 'sales' ? 'Rapport ventes' : 'Analytics utilisateurs',
        format: exportConfig.format.toUpperCase(),
        status: 'completed',
        createdAt: new Date().toISOString(),
        downloadUrl: `/exports/analytics-${exportConfig.type}.${exportConfig.format}`,
  ...
  const downloadExport = (exportId: string) => {
    ...
    if (exportItem && exportItem.downloadUrl) {
      ...
      link.download = `analytics-${exportItem.type.toLowerCase()}.${exportItem.format.toLowerCase()}`
  ...
  const toggleReportStatus = (reportId: string) => {
    setReports(prev => prev.map(report => ({
      ...report,
      isActive: report.id === reportId ? !report.isActive : report.isActive
    })))
  }
  ...
  const generateUsersReport = async () => {
    ...
    try {
      ...
      addNotification({
        ...
        message: 'Rapport des utilisateurs généré avec succès !'
      })
  ...
  const generateProductsReport = async () => {
    ...
    try {
      ...
      addNotification({
        ...
        message: 'Rapport des produits généré avec succès !'
      })
  ...
  const generateMarketingReport = async () => {
    ...
    try {
      ...
      addNotification({
        ...
        message: 'Rapport marketing généré avec succès !'
      })
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium">Janvier</span>
                    <div className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium">Février</span>
                    <div className="flex items-center space-x-2">
                      <div className="w-32 bg-gray-200 rounded-full h-2">
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="text-center p-4 border border-gray-200 rounded-lg">
                  <p className="text-2xl font-bold text-purple-600">15.3s</p>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-sm text-gray-600">45.2M vs 38.1M FCFA</p>
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-4 border border-gray-200 rounded-lg text-center">
                    <p className="text-lg font-medium">Commandes</p>
                    <p className="text-3xl font-bold text-blue-600">8,923</p>
                    <p className="text-sm text-gray-600">+12.3% vs mois dernier</p>
                  </div>
                  <div className="p-4 border border-gray-200 rounded-lg text-center">
                    <p className="text-lg font-medium">Panier Moyen</p>
                    <p className="text-3xl font-bold text-green-600">5,067</p>
                    <p className="text-sm text-gray-600">+5.8% vs mois dernier</p>
                  </div>
                  <div className="p-4 border border-gray-200 rounded-lg text-center">
                    <p className="text-lg font-medium">Clients Uniques</p>
                    <p className="text-3xl font-bold text-purple-600">6,847</p>
                    <p className="text-sm text-gray-600">+8.9% vs mois dernier</p>
                  </div>
                </div>
              </div>
            </CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm">36+ ans</span>
                      <div className="flex items-center space-x-2">
                        <div className="w-24 bg-gray-200 rounded-full h-2">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
                      ...
                      <span className="font-medium">156,892</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <TabsContent value="produits" className="space-y-4">
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                {[
                  { id: 1, name: "iPhone 15 Pro", category: "Électronique", sales: 234, revenue: "2.3M", growth: "+15.2%" },
                  { id: 2, name: "Samsung Galaxy S24", category: "Électronique", sales: 189, revenue: "1.8M", growth: "+12.8%" },
                  { id: 3, name: "MacBook Air M2", category: "Informatique", sales: 156, revenue: "3.1M", growth: "+8.9%" },
                  { id: 4, name: "AirPods Pro", category: "Accessoires", sales: 298, revenue: "0.9M", growth: "+22.1%" }
                ].map((product) => (
                  <div key={product.id} className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
                    ...
                    <div className="flex items-center space-x-6">
                      ...
                      <div className="text-center">
                        ...
                        <p className="font-medium">{product.revenue} FCFA</p>
                      </div>
                      <div className="text-center">
                        <p className="text-sm text-gray-600">Croissance</p>
                        <p className="font-medium text-green-600">{product.growth}</p>
                      </div>
                    </div>
                  </div>
                ))}
