                        ...
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild>
                            <Button variant="ghost" size="sm" className="h-8 w-8 p-0 text-gray-400 hover:text-gray-600 transform hover:scale-110 active:scale-95 transition-all duration-300 ease-out group relative overflow-hidden">
                              ...
                              <div className="absolute inset-0 rounded-full bg-gray-200/20 animate-ping opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                            </Button>
                          </DropdownMenuTrigger>
                          <DropdownMenuContent className="w-48 p-2">
                            <DropdownMenuItem 
                              onClick={() => handleShare(item, 'whatsapp')}
                              className="flex items-center space-x-3 p-3 rounded-lg hover:bg-green-50 hover:text-green-700 transform hover:scale-105 active:scale-95 transition-all duration-300 ease-out group cursor-pointer"
                            >
                              <div className="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center group-hover:animate-bounce transition-all duration-300">
                            ...
                            <DropdownMenuItem 
                              ...
                              className="flex items-center space-x-3 p-3 rounded-lg hover:bg-blue-50 hover:text-blue-700 transform hover:scale-105 active:scale-95 transition-all duration-300 ease-out group cursor-pointer"
                            >
                              <div className="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center group-hover:animate-pulse transition-all duration-300">
                            ...
                            <DropdownMenuItem 
                              ...
                              className="flex items-center space-x-3 p-3 rounded-lg hover:bg-sky-50 hover:text-sky-700 transform hover:scale-105 active:scale-95 transition-all duration-300 ease-out group cursor-pointer"
                            >
                              <div className="w-8 h-8 bg-sky-500 rounded-full flex items-center justify-center group-hover:animate-bounce transition-all duration-300">
                            ...
                            <DropdownMenuItem 
                              ...
                              className="flex items-center space-x-3 p-3 rounded-lg hover:bg-purple-50 hover:text-purple-700 transform hover:scale-105 active:scale-95 transition-all duration-300 ease-out group cursor-pointer"
                            >
                              <div className="w-8 h-8 bg-purple-500 rounded-full flex items-center justify-center group-hover:animate-pulse transition-all duration-300">
