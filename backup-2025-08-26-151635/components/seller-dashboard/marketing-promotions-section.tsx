...
// Types pour les promotions et campagnes
interface Promotion {
  id: string
  name: string
...
interface Campaign {
  id: string
  name: string
  type: 'social' | 'email' | 'push' | 'banner' | 'boostage'
  ...
  // Propriétés spécifiques aux boostages
  boostageType?: 'recommandation' | 'banniere' | 'whatsapp'
  boostagePages?: string[]
  boostageDuration?: number // en jours
  boostageCost?: number // coût total du boostage
  boostageRemainingDays?: number
  boostagePerformance?: {
    views: number
    clicks: number
    conversions: number
...
export default function MarketingPromotionsSection() {
  ...
  const createBoostingCampaign = () => {
    ...
    // Rediriger vers l'onglet campagnes
                 ...
                 <CardHeader className="pb-3">
                   <div className="flex items-center justify-between">
                     ...
                     <div className="flex items-center gap-2">
                       ...
                       {campaign.type === 'boostage' && campaign.status === 'pending' && (
