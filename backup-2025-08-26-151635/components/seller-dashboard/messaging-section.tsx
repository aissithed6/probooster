...
export default function MessagingSection() {
  ...
  const handleConversationAction = (action: 'history' | 'delete') => {
    ...
    if (action === 'history') {
      ...
      if (confirm(`Êtes-vous sûr de vouloir supprimer la conversation avec ${selectedConversation.clientName} ?`)) {
  ...
  const manageQuickReply = (action: 'add' | 'remove', index?: number) => {
    if (action === 'add') {
      ...
      if (confirm('Êtes-vous sûr de vouloir supprimer cette réponse rapide ?')) {
