...
export default function TestNewArrivalsPage() {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            🧪 Test des Nouvelles Arrivées
          </h1>
          <p className="text-lg text-gray-600">
            Testez la fonctionnalité d'achat avec points sur les cartes produits des nouvelles arrivées
          </p>
        </div>
        ...
        <NewArrivalsSection onProductClick={handleOpenProductModal} />
