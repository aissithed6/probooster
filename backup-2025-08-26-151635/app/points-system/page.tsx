...
export default function PointsSystemPage() {
  ...
  const pointsValue = 6500 // 1 point = 2 F CFA
  ...
  const rewards = [
    ...
    },
    {
      ...
      description: "Convertissez vos points en F CFA",
      examples: ["1 point = 2 F CFA", "Retrait minimum 5000 F", "Paiement sécurisé"]
    },
    {
      icon: Package,
      title: "Produits Gratuits",
      description: "Obtenez des produits sans dépenser",
      examples: ["Produits sélectionnés", "Livraison incluse", "Valeur jusqu'à 50,000 F"]
    },
    {
      icon: Crown,
              ...
              <div className="flex items-center justify-center space-x-4 mb-4">
                ...
                <div className="text-center">
                  ...
                  <div className="text-white/80 group-hover:text-white transition-colors duration-300">
                    Valeur: {showPoints ? `${pointsValue.toLocaleString()} F CFA` : "••••••"}
                  </div>
                </div>
              </div>
                    ...
                    <div key={index} className="flex items-center space-x-4 p-4 rounded-lg hover:bg-gray-50 transition-colors group">
                      ...
                      <div className="ml-auto text-right">
                        ...
                        <div className="text-sm text-gray-500 group-hover:text-gray-700 transition-colors duration-300">
                          {Math.floor(user.points * 2).toLocaleString()} F CFA
                        </div>
                      </div>
                    </div>
                  ))}
