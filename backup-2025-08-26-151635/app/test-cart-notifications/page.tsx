...
// Produits de test avec des IDs numériques
const testProducts = [
  {
    id: 1,
...
export default function TestCartNotificationsPage() {
  const { 
    cartItems, 
    cartCount, 
    cartTotal, 
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            🧪 Test des Notifications du Panier
          </h1>
          <p className="text-lg text-gray-600">
            Testez que les notifications s'affichent correctement lors des actions du panier
          </p>
        </div>
              ...
              <Card key={product.id} className="overflow-hidden">
                ...
                <CardContent className="p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Button
                      onClick={() => {
                        console.log("Tentative de toggle wishlist:", product)
                        const result = toggleWishlist(product)
                        console.log("Résultat du toggle:", result)
                      }}
                      variant="outline"
                      className={`w-full ${
        ...
        <Card className="mt-12 bg-blue-50 border-blue-200">
          ...
          <CardContent className="space-y-2 text-blue-700">
            ...
            <p>• <strong>Vérifiez les notifications</strong> : Une notification de succès doit apparaître en haut à droite</p>
            ...
            <p>• <strong>Console</strong> : Ouvrez la console du navigateur pour voir les logs</p>
            <p>• <strong>Notifications vides</strong> : Si les notifications sont vides, vérifiez la console pour les erreurs</p>
          </CardContent>
        </Card>
        ...
        <Card className="mt-6 bg-yellow-50 border-yellow-200">
          ...
          <CardContent className="space-y-2 text-yellow-700 text-sm">
            <p>• <strong>Cart Items:</strong> {JSON.stringify(cartItems, null, 2)}</p>
            <p>• <strong>Wishlist Items:</strong> {JSON.stringify(wishlistItems, null, 2)}</p>
