...
import { Eye, EyeOff, Mail, Lock, User, Sparkles, TrendingUp, Gift, Coins, ArrowRight, CheckCircle, AlertCircle, Zap, Shield, Globe, MessageCircle } from "lucide-react"
            ...
            <Card className="w-full max-w-md bg-white/10 backdrop-blur-sm border-white/20 shadow-2xl animate-fade-in-up animation-delay-200">
              <CardHeader className="text-center">
                <CardTitle className="text-2xl font-bold text-white mb-2">
                  {loginStep === 1 && "Connexion"}
                  {loginStep === 2 && "Vérification"}
                  {loginStep === 3 && "Bienvenue !"}
                </CardTitle>
                <p className="text-gray-300">
                  {loginStep === 1 && "Accédez à votre compte Probooster"}
                  {loginStep === 2 && "Vérification de votre identité..."}
                  {loginStep === 3 && "Connexion réussie !"}
                </p>
              </CardHeader>
              ...
              <CardContent className="space-y-6">
                ...
                {loginStep === 2 && (
                  <div className="text-center space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">Nous vérifions vos informations de connexion</p>
                    </div>
                ...
                {loginStep === 3 && (
                  <div className="text-center space-y-6">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-white mb-2">Connexion réussie !</h3>
