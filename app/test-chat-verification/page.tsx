...
/**
 * Page de test: vérifie l'ouverture du widget chat global.
 * IMPORTANT: useChatContext doit être utilisé sous ChatProvider.
 */
export default function TestChatVerificationPage() {
  return (
    <ChatProvider>
      <TestChatVerificationPageInner />
    </ChatProvider>
  )
}

/**
 * Composant interne (sous ChatProvider) contenant la logique et l'usage de useChatContext.
 */
function TestChatVerificationPageInner() {
  const { openChatWidget } = useChatContext()
