...
export default function BecomeSellerPage() {
  ...
  const specialOffers = [
    {
      title: "Pack Démarrage Premium",
      description: "Formation complète + support prioritaire + accès à toutes les fonctionnalités",
      price: "199 000 XOF",
      features: [
      ...
      color: "from-[#ff6600]/90 to-[#ff8533]/90",
      textColor: "text-white"
    },
    {
      title: "Offre Startup",
      description: "Parfait pour lancer votre activité en ligne avec un budget maîtrisé",
      price: "99 000 XOF",
      features: [
    ...
    },
    {
      ...
      description: "Développez votre présence à l'international avec nos outils avancés",
      price: "249 000 XOF",
      features: [
