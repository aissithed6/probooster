...
import { Cookie, Shield, Settings, Eye, CheckCircle, Info, ArrowRight, Users, Clock, Calendar, Sparkles, BarChart3, Target, RefreshCw, Lock, Mail, Phone, MapPin, MessageCircle, Download, ExternalLink, Copy, Globe as GlobeIcon, Zap, X } from "lucide-react"
...
type Section = {
  id: "types" | "gestion" | "preferences" | "securite" | "duree" | "tiers"
  title: string
  icon: IconComponent
}
...
export default function CookiesPage() {
  const [activeSection, setActiveSection] = useState<Section["id"]>("types")
  ...
  const cookieDuration: CookieDuration[] = [
