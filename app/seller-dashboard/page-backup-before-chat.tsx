...
import ChatSection from '@/components/seller-dashboard/chat-section'
...
export default function SellerDashboardPage() {
  ...
  const vendorId = 'e55ee043-8501-4099-b589-ab487e98bb77' // ID temporaire, à remplacer par l'ID réel du vendeur connecté
  ...
  const orders: SellerOrder[] = dashboardData?.orders || []
  ...
  const deliveredOrders = dashboardData?.orders?.filter(order => order.status === 'delivered') || []
  ...
  if (orderIndex !== -1) {
    deliveredOrders[orderIndex].isPaymentRequested = true
    deliveredOrders[orderIndex].paymentRequestDate = new Date().toISOString()
  }
