...
/**
 * Composant de messagerie interne synchronisé pour le tableau de bord CLIENT
 * Identique à la version vendeur mais adapté pour les clients
 */
...
export default function InternalMessagingSectionSyncedClient() {
  const { user } = useAuth()
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Filtres et recherche - Identique à la version vendeur */}
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
      ...
      {/* Liste des messages - Identique à la version vendeur */}
      <Card>
        <CardHeader>
          ...
          {isLoading ? (
            ...
            <div className="space-y-4">
              {filteredMessages.map((message) => (
                <Card
                  key={message.id}
                  className={`hover:shadow-md transition-shadow ${!message.is_read ? 'border-l-4 border-l-blue-500 bg-blue-50' : ''}`}
                >
                      ...
                      <div className="flex-1 space-y-3">
                        <div className="flex items-center space-x-3">
                          ...
                          {!message.is_read && message.recipient_id === user?.id && (
                            <Badge className="bg-blue-500 text-white text-xs animate-pulse">Nouveau</Badge>
                          )}
                        </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3 pb-3 border-b">
                <div className="w-10 h-10 bg-gradient-to-br from-blue-100 to-blue-200 rounded-full flex items-center justify-center">
                  <span className="text-sm font-semibold text-blue-700">{senderInfo?.name?.charAt(0) || 'A'}</span>
                </div>
                <div>
              ...
              <div className="flex items-center space-x-2 pt-3 border-t">
                ...
                <Badge variant="outline">Priorité: {selectedMessage.priority}</Badge>
