    ...
    <Card className="group hover:shadow-2xl transition-all duration-500 overflow-hidden border-0 bg-white rounded-2xl transform hover:scale-105 hover:-translate-y-2 cursor-pointer relative">
      <div className="relative overflow-hidden">
            ...
            if (onProductClick) {
              ...
              const enrichedProduct = {
                ...
                seller: {
                  ...
                  avatar: "",
                  rating: ratingForUi,
                  totalSales: Number.isFinite(Number((product as any)?.sales)) ? Math.max(0, Math.floor(Number((product as any).sales))) : 0,
                  responseTime: "",
                  location: "",
                  phone: "",
                  email: "",
        ...
        <div className="absolute top-3 left-3 flex flex-col space-y-2">
          {/* Badge NOUVEAU avec animation spéciale */}
          <Badge className="bg-gradient-to-r from-green-500 to-emerald-600 text-white border-0 animate-pulse shadow-lg relative overflow-hidden">
            {/* Effet de brillance */}
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent -translate-x-full animate-pulse" style={{ animationDuration: '2s' }}></div>
      ...
      <CardContent className="p-6">
        <div className="space-y-4">
          {/* Indicateurs de nouveauté - placés au-dessus du nom */}
          <div className="flex items-center justify-between">
            {/* Indicateur de nouveauté avec animation */}
            <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-3 py-1 rounded-full text-sm font-semibold animate-bounce shadow-lg border-2 border-white">
            ...
            {/* Indicateur de jours depuis l'ajout */}
            <div className="bg-gradient-to-r from-green-500 to-emerald-600 text-white px-3 py-1 rounded-full text-sm font-semibold animate-bounce shadow-lg border-2 border-white">
              <div className="flex items-center space-x-1">
                ...
                <span>Il y a {product.daysAgo} jour{product.daysAgo > 1 ? 's' : ''}</span>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col space-y-3 w-full">
          <div className="flex space-x-3 w-full">
            <Button
              ...
              onClick={() => addToCart({ ...product, warranty: (product as any)?.warranty, returnPolicy: (product as any)?.returnPolicy })}
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="flex space-x-1">
                        <div className="w-1 h-1 bg-yellow-400 rounded-full animate-pulse"></div>
                        <div className="w-1 h-1 bg-yellow-400 rounded-full animate-pulse" style={{ animationDelay: '0.2s' }}></div>
                        <div className="w-1 h-1 bg-yellow-400 rounded-full animate-ping opacity-0 group-hover:opacity-100 transition-opacity duration-500" style={{ animationDelay: '0.4s' }}></div>
                      </div>
                    </div>
                  </div>
